...
const EventFeedbackModal = ({ visible, onClose, eventName, eventId }) => {
    ...
    const fetchReviews = async () => {
        try {
            const response = await fetch(`http://${ip}:${port}/review/event/${eventId}`);
        ...
        >
            <SafeAreaView style={styles.safeArea}>
                <View style={styles.modalContent}>
                    ...
                    <Text style={styles.text}>Feedback {eventName}</Text>
